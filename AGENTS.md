...
This repo is `agent-creator-agent`. Its canonical first product is a self-clone
renamed `ce-rd-os`. The fork-and-rename ritual is in `INSTALL_BOOTLEG.md`. The
skills below are the spec for both the agent creator and the ce-rd-os bundle it
produces.
